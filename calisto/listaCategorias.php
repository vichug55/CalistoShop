<?php
   ...
   if($_SERVER['REQUEST_METHOD']==='POST'){
    ...
    if($id){
        ...
        $queryArticulosSelect="SELECT * FROM articulos WHERE cat_id='$id'";
        ...
        $queryArticulos="DELETE FROM articulos WHERE cat_id='$id'";
        $resultadoArticulos=mysqli_query($db,$queryArticulos);


        $queryBanner="DELETE FROM banners WHERE cat_id='$id'";
        $resultadoBanner=mysqli_query($db,$queryBanner);
...
<body>
    ...
    <table class="empleados">
        ...
        <tbody>
            ...
            <tr class="filas">
                <td style="text-align: center;"><?php echo $categorias['id']; ?></td>
                <td style="text-align: center;"><?php echo $categorias['categoria']; ?></td>
                <td style="text-align: center;"><?php echo $categorias['estado']; ?></td>
                <td>
                    <form method="POST">
                        <input type="hidden" name="id" value="<?php echo $categorias['id']; ?>">
                        <input type="submit" value="Eliminar categoria" class="boton-eliminar" onsubmit="return confirmacionEliminar()" >
                    </form>
                    <a href="actualizarCategoria.php?id=<?php echo $categorias['id']; ?>" class="boton-actualizar" >Actualizar categoria</a>
                </td>
            </tr>
            <?php endwhile;?>
        </tbody>
