<?php
   ...
   $query="SELECT articulos.id AS ato_id, articulos.nombre,colores.color, colores.imagen,colores.id AS col_id
   FROM colores
   LEFT JOIN articulos ON colores.ato_id=articulos.id;";
   $resultado=mysqli_query($db,$query);
...
<body>
    ...
    <table class="empleados">
        ...
        <tbody>
            <?php while($colores=mysqli_fetch_assoc($resultado)):?>
            <tr class="filas">
                <td><?php echo $colores['ato_id']; ?></td>
                <td><?php echo $colores['nombre']; ?></td>
                <td style="background-color: <?php echo $colores['color']; ?>;"></td>
                <td><img class="imagen-lista" src="imagenes/articulos/<?php echo $colores['imagen']; ?>" onerror="this.src='imagenes/articulos/<?php echo $articulos['imagen']; ?>'"></td>
                <td>
                    <a href="actualizarColor.php?id=<?php echo $colores['col_id']; ?>" class="boton-actualizar" >Actualizar color</a>
                </td>
            </tr>
            <?php endwhile;?>
        </tbody>
